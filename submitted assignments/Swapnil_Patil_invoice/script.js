class InvoiceComponent extends HTMLElement {
    ...
    defaultData = {
        ...
        items: [
            { SL: 1, Description: `100.00`, SQ: 3, Total: 270.00 },
            { SL: 2, Description: `50.00`, SQ: 6, Total: 300.00  },
            { SL: 3, Description: `50.00`, SQ: 6, Total: 300.00 }
        ],
        subTotal: 570.00,
        discount: 30.00,
    ...
    render() {
        ...
        date.textContent = 'Apnasite MMEAC | Date:2 Feb, 2025';
        ...
        // Seller information
        const sellerInfo = this.createInfoSection('Bill to:', seller);
        details.appendChild(sellerInfo);
    
        // Client information
        const clientInfo = this.createInfoSection('Ship to:', client);
